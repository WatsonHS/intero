...
export const KanbanCardId = uuidSchema.brand<"KanbanCardId">();
export const EpicId = uuidSchema.brand<"EpicId">();
export const FeatureId = uuidSchema.brand<"FeatureId">();
export const WorkItemId = uuidSchema.brand<"WorkItemId">();
...
export type KanbanCardId = z.infer<typeof KanbanCardId>;
export type EpicId = z.infer<typeof EpicId>;
export type FeatureId = z.infer<typeof FeatureId>;
export type WorkItemId = z.infer<typeof WorkItemId>;
export type ProgramIncrementId = z.infer<typeof ProgramIncrementId>;
export type SprintId = z.infer<typeof SprintId>;
export type WorkCommentId = z.infer<typeof WorkCommentId>;
export type SpecCommentThreadId = z.infer<typeof SpecCommentThreadId>;
export type SpecCommentId = z.infer<typeof SpecCommentId>;
