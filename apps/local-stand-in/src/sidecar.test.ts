...
import { LocalStandInRuntime } from "./runtime";
...
class MemoryDaemon implements DaemonClient {
  ...
  async call(
    ...
    if (method === "stand_in.complete_request") {
