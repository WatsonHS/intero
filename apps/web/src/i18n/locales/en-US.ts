...
export const enUS: Record<TranslationKey, string> = {
  "app.search": "Search",
  "search.title": "Search people and content you can see",
  "search.lede":
    "Search contacts, messages, work items, Specs, comments, explicit code references, coordination, and your Stand-in activity. Encrypted and private raw content never appears.",
  "search.placeholder": "Type at least two characters",
  "search.placeholderMessages":
    "Search messages, e.g. deploy in:room from:Alex before:2026-09-01 has:attachment",
  "search.syntaxHint":
    "Filters: in:thread, from:sender, before:YYYY-MM-DD, after:YYYY-MM-DD, has:attachment",
  "search.projectScope": "Project scope",
  "search.allProjects": "All accessible projects",
  "search.minChars": "Type at least two characters, or add a filter",
  "search.searching": "Searching…",
  "search.empty": "No matching contacts or authorized content",
  "search.emptyMessages": "No matching messages",
  "search.contacts": "Contacts",
  "search.content": "Content",
  "search.tab.content": "Content",
  "search.tab.messages": "Messages",
  "search.type.work_item": "Work item",
  "search.type.spec": "Spec",
  "search.type.spec_version": "Spec version",
  "search.type.comment": "Comment",
  "search.type.code_reference": "Code reference",
  "search.type.coordination": "Coordination",
  "search.type.stand_in_activity": "Stand-in activity",
  "search.filter.from": "From",
  "search.filter.fromPlaceholder": "Name or ID",
  "search.filter.before": "Before",
  "search.filter.after": "After",
  "search.filter.hasAttachment": "Has attachment",
  "search.unknownSender": "Unknown sender",
  ...
  "chat.searchPlaceholder": "Search in this thread… in: is implied",
  "chat.searchNoHits": "No matches",
  ...
  "chat.emoji": "Choose an emoji",
  "chat.emojiSearch": "Search emoji",
  "chat.emojiGroups": "Emoji categories",
  "chat.emojiLoading": "Loading emoji…",
  "chat.emojiLoadFailed": "Emoji could not be loaded. Try again later.",
  "chat.emojiNoResults": "No emoji match.",
  "chat.emojiGroupSmileys": "Smileys & emotion",
  "chat.emojiGroupPeople": "People & body",
  "chat.emojiGroupNature": "Animals & nature",
  "chat.emojiGroupFood": "Food & drink",
  "chat.emojiGroupTravel": "Travel & places",
  "chat.emojiGroupActivities": "Activities",
  "chat.emojiGroupObjects": "Objects",
  "chat.emojiGroupSymbols": "Symbols",
  "chat.emojiGroupFlags": "Flags",
  "chat.addReaction": "Add an emoji reaction",
  "chat.reactWith": "React with {emoji}",
  "chat.reactionSummary": "{emoji}, {count} reactions",
  "chat.reactionFailed": "The reaction could not be saved. Try again.",
  "chat.reply": "Reply",
  "chat.replyingTo": "Replying to {name}",
  "chat.cancelReply": "Cancel reply",
  "chat.replyAttachment": "[Image]",
  "chat.replyPdf": "[PDF]",
  ...
  "chat.deleteConfirmBody":
    "The message content is removed, but its sequence stays.",
  "chat.deleteConfirm": "Delete",
  "chat.editFailed": "The edit could not be saved. Try again.",
  "chat.deleteFailed": "The message could not be deleted. Try again.",
  ...
  "chat.attachImage": "Attach image or PDF",
  "chat.imageUploading": "Securely uploading and scanning the attachment…",
  "chat.imageUploadFailed":
    "Attachment upload failed. Remove it and try again.",
  "chat.imageTypeUnsupported": "Use a JPEG, PNG, GIF, WebP, AVIF, or PDF file.",
  "chat.imageTooLarge": "Each attachment must be 25 MB or smaller.",
  "chat.removeImage": "Remove attachment",
  "chat.linkPreview": "Link preview",
  "chat.hideLinkPreview": "Remove preview",
  "chat.linkPreviewImage": "Link preview image",
  "chat.pdfPreview": "PDF preview",
  "chat.openPdf": "Open PDF",
  "chat.downloadPdf": "Download PDF",
  "chat.closePdf": "Close PDF preview",
  ...
  "chat.coordination.scope.single_project": "Single Project",
  "chat.coordination.scope.cross_project": "Cross-Project",
  "chat.coordination.scope.team": "Team scope",
  "chat.coordination.scope.ambiguous": "Scope needs confirmation",
  "chat.coordination.scopeProjectCount": "{count} Project(s)",
  "chat.coordination.whatChanged": "What changed",
  "chat.coordination.whyItMatters": "Why it matters",
  "chat.coordination.needsFromYou": "Needs from you",
  "chat.coordination.options": "Options",
  ...
  "chat.mute": "Mute",
  "chat.mute1h": "Mute for 1 hour",
  "chat.mute8h": "Mute for 8 hours",
  "chat.muteIndefinitely": "Mute until I turn it back on",
  "chat.muteIncludingMentions": "Mute including @mentions",
  "chat.unmute": "Unmute",
  "chat.muted": "Muted",
  "chat.browseChannels": "Browse channels",
  "chat.channelDirectory": "Channel directory",
  "chat.channelSearch": "Search channels",
  "chat.noChannels": "No channels match.",
  "chat.join": "Join",
  "chat.leave": "Leave",
  "chat.joined": "Joined",
  "chat.memberCountShort": "{count} members",
  "chat.latestActivity": "Latest activity",
  "chat.visibility": "Visibility",
  "chat.visibilityPrivate": "Invite only",
  "chat.visibilityTeam": "Visible to the team",
  "chat.visibilityTeamHint": "Team members can find and join this Room.",
  "chat.archive": "Archive",
  "chat.unarchive": "Unarchive",
  "chat.archived": "Archived",
  "chat.archivedFilter": "Archived",
  "chat.archivedEmpty": "No archived conversations.",
  "chat.archivedReadOnly": "This Room is archived and read-only.",
  "chat.hideForMe": "Hide for me",
  "chat.call": "Call",
